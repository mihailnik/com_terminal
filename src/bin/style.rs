use iced::keyboard;
use iced::widget::{
    button, center_x, center_y, checkbox, column, container, horizontal_rule, pick_list,
...
impl Styling {
    ...
    fn view(&self) -> Element<'_, Message> {
        ...
        let check = checkbox("Check me!", self.checkbox_value).on_toggle(Message::CheckboxToggled);
